    ...
    <main className="min-h-screen bg-offwhite">
      ...
      <section className="section max-w-2xl mx-auto space-y-6 text-ink/80 leading-relaxed">
        <p>
          ...
          work — fundis, artisans, and domestic workers who do skilled,
        ...
        <p>
          PataFundi exists to fix that. Every fundi on the platform is
        ...
        <p>
          ...
          real, verifiable earnings history — the kind of record a fundi can
        ...
        <div className="grid sm:grid-cols-3 gap-6 pt-6">
          <div className="bg-white rounded-card p-5 border border-ink/10 text-center">
            ...
            <p className="text-ink/50 text-sm">ID-verified fundis</p>
          </div>
          <div className="bg-white rounded-card p-5 border border-ink/10 text-center">
