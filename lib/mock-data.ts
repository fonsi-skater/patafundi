...
export const trustBadges = [
  { label: "ID Verified Fundis", icon: "shield-check" },
...
export const whyDifferent = [
  {
    ...
    description:
      "Every fundi on PataFundi has a confirmed ID and a real work history — not a stranger you found through a poster on a pole.",
  },
  {
    title: "Reviews you can actually trust",
    description:
      "Only clients who paid for a completed job through PataFundi can leave a review. No fake five-star spam.",
  },
  {
    title: "Your money is protected",
    description:
      "Payment sits safely with us until the job is confirmed done — the fundi doesn't get paid until you're satisfied.",
  },
  {
    title: "A record that builds over time",
    description:
      "Every completed job adds to a fundi's earnings history — real proof of income they can eventually show a bank or sacco.",
  },
];
...
export const testimonials = [
  ...
  },
  {
    ...
    quote:
      "We use PataFundi for all our maintenance work now. The contract feature means there's no argument about price afterward.",
    rating: 5,
  },
  {
    name: "James Fundi",
